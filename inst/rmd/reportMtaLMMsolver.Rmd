  ...
  if("params" %in% ls()){ # we will download the document
    ...
    inputPanel(
      selectInput(ns("boxplotMtaPredsType"),
                  label = "Effect type",
                  choices = effectTypes[effectTypes %in% c("environment_designation", "designation")]
      ),
      column(width=12),
...
if (is.null(result)){
  ...
  if("params" %in% ls()){ # we will download the document
    ...
    # if(length(setdiff(effectTypes, c("environment", "designation", "(Intercept)"))) > 0){
      if("environment_designation" %in% effectTypes){
          inputPanel(
...
if (is.null(result)){
  ...
  if("params" %in% ls()){ # we will download the document
    ...
    for(iType4 in effectTypes[effectTypes %in% c("environment_designation", "designation")]){
